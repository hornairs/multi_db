# This is 99% from schoefmax/tlattr_accessors, but does not define
# finalizers on Thread.main. It was easier to just drop it into this
# codebase than to juggle dependencies.
